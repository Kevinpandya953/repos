...
{
    public partial class AddMigration20230605bikestore1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__brands__5E5A8E278991E306", x => x.brand_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__categori__D54EE9B4E525BBE4", x => x.category_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__customer__CD65CB85FCDB8A7B", x => x.customer_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stores__A2F2A30C3B991D58", x => x.store_id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__products__47027DF5D4387B15", x => x.product_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__staffs__1963DD9C6F993C6A", x => x.staff_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__stocks__E68284D39B919559", x => new { x.store_id, x.product_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__orders__46596229B9BF3DC6", x => x.order_id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__order_it__837942D4B76F9112", x => new { x.order_id, x.item_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__staffs__AB6E616466BA219F",
                schema: "sales",
                table: "staffs",
                column: "email",
                unique: true);
