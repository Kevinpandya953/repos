...
namespace WebApplication8.Migrations
{
    ...
    [Migration("20230605095201_Add-Migration 20230605bikestore1")]
    partial class AddMigration20230605bikestore1
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Brands", b =>
                {
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Categories", b =>
                {
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Customers", b =>
                {
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.OrderItems", b =>
                {
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Orders", b =>
                {
                    b.Property<int>("OrderId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("order_id")
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Products", b =>
                {
                    b.Property<int>("ProductId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("product_id")
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Staffs", b =>
                {
                    b.Property<int>("StaffId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("staff_id")
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Stocks", b =>
                {
                    b.Property<int>("StoreId")
                        .HasColumnName("store_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Stores", b =>
                {
                    b.Property<int>("StoreId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("store_id")
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.OrderItems", b =>
                {
                    b.HasOne("WebApplication8.Data.Models.Orders", "Order")
                        .WithMany("OrderItems")
                    ...
                    b.HasOne("WebApplication8.Data.Models.Products", "Product")
                        .WithMany("OrderItems")
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Orders", b =>
                {
                    b.HasOne("WebApplication8.Data.Models.Customers", "Customer")
                        .WithMany("Orders")
                        .HasForeignKey("CustomerId")
                        .HasConstraintName("FK__orders__customer__34C8D9D1")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("WebApplication8.Data.Models.Staffs", "Staff")
                        .WithMany("Orders")
                        .HasForeignKey("StaffId")
                        .HasConstraintName("FK__orders__staff_id__36B12243")
                        .IsRequired();

                    b.HasOne("WebApplication8.Data.Models.Stores", "Store")
                        .WithMany("Orders")
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Products", b =>
                {
                    b.HasOne("WebApplication8.Data.Models.Brands", "Brand")
                        .WithMany("Products")
                    ...
                    b.HasOne("WebApplication8.Data.Models.Categories", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("WebApplication8.Data.Models.Staffs", b =>
                {
                    b.HasOne("WebApplication8.Data.Models.Staffs", "Manager")
